...
const bookAppointment = async (req, res) => {
    try {
        ...
        if (!docData.available) {
            return res.json({ success: false, message: 'Đầu bếp không có sẵn' })
        }
        ...
        res.json({ success: true, message: 'Đầu bếp đã được đặt' })
...
const cancelAppointment = async (req, res) => {
    try {
        ...
        res.json({ success: true, message: 'Đặt chỗ đã bị hủy' })
...
const paymentRazorpay = async (req, res) => {
    try {
        ...
        if (!appointmentData || appointmentData.cancelled) {
            return res.json({ success: false, message: 'Đặt chỗ đã bị hủy hoặc không tìm thấy' })
        }
